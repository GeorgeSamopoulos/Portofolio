...
public class LoginUser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try(PrintWriter out = response.getWriter()){;
            ...
            out.println(LoginData(us) + "<br>" + LoadDoctors() + "<br>");
            out.close();
    ...
    public String LoginData(SimpleUser us){
        String result = "<h3>User's Data</h3>";
        ...
        result += "<input type=\"button\" value=\"Change Data\" onclick=\"TestData();\">";
        return result;
    }


    public String LoadDoctors(){
        String result = "";
        EditDoctorTable dr = new EditDoctorTable();
        try{
            ArrayList<Doctor> dcs = dr.databaseToDoctors();
            result += "<h3>Doctors</h3> <br>";
            result += "<p id='doctinfo'>";
            for(int i=0;i<dcs.size();i++){
                ...
                if(d.getCertified()==1){
                    ...
                    String tl = d.getTelephone();
                    result += "First Name : " + fn + "&emsp; Last Name : " + ln + "&emsp; Address : " + ad + "&emsp; City : " + ct + "&emsp; Specialty : " + sp + "&emsp; Telephone : " + tl;
                    result+="<br>";
                }
            }
